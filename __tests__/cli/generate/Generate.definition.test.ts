...
describe("Generate definition", () => {
    it("should match the snapshot", () => {
        ...
        let error;
        try {
            contents = fs.readFileSync(__dirname + "/../../../src/cli/generate/Generate.definition.ts").toString();
        } catch (e) {
            error = e;
            Imperative.console.error(`Error reading Generate.definition.ts Did you move the file? Details: ${e.message}`);
        }
