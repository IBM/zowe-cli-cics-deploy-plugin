...
describe("bundle definition", () => {
    it("should match the snapshot", () => {
        ...
        let error;
        try {
            contents = fs.readFileSync(__dirname + "/../../../../src/cli/push/bundle/PushBundle.definition.ts").toString();
        } catch (e) {
            error = e;
            Imperative.console.error(`Error reading PushBundle.definition.ts Did you move the file? Details: ${e.message}`);
        }
