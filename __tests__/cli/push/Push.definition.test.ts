...
describe("Push definition", () => {
    it("should match the snapshot", () => {
        ...
        let error;
        try {
            contents = fs.readFileSync(__dirname + "/../../../src/cli/push/Push.definition.ts").toString();
        } catch (e) {
            error = e;
            Imperative.console.error(`Error reading Push.definition.ts Did you move the file? Details: ${e.message}`);
        }
